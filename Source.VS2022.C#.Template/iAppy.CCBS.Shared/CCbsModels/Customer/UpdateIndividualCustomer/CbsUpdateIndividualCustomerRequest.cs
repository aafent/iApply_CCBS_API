...
{
    public class CbsUpdateIndividualCustomerRequest : MockupModel
    {
        ...
        public List<CustomerIdentification> CustomerIdentifications { get; set; } = new List<CustomerIdentification>();
