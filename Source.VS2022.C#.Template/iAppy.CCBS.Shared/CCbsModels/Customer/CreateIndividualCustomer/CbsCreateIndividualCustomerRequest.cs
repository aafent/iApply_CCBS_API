...
using iApply.CCBS.Shared.CCbsModels.Customer.CreateIndividualCustomer;
using IApplyDataAccess.DataModel;
using iApplyShared.Attributes;

namespace iApplyShared.CbsModels
{
    public class CbsCreateIndividualCustomerRequest : MockupModel
    {
        ...
        public IndividualCustomerView IndividualCustomerViews { get; set; }
