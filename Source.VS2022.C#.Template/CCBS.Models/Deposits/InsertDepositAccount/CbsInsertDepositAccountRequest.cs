...
{
    public class CbsInsertDepositAccountRequest : BaseCbsRequestModel
    {
        ...
        /// </summary>
        public string CurencyDescr { get; set; }
        ...
        /// <summary>
        /// Main Applicant Check Digit (integer)
        /// </summary>
        ...
        /// </summary>
        public int SecondaryAccountNumber_Cd { get; set; }
